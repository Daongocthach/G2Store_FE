...
import { Button, Dialog, DialogActions, DialogContent, DialogTitle, Typography, Box, Grid } from '@mui/material'
...
function TrackingOrder({ order }) {
  ...
  return (
    <Box>
      <Button variant='contained' size='small' onClick={handleClickOpen}>Tra cứu đơn hàng</Button>
