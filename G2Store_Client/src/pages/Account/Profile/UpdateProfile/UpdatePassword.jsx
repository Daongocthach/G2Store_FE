            ...
            <Dialog open={open} keepMounted onClose={() => { setOpen(false), setTouched(false) }} >
                ...
                <DialogContent className='w-full'>
                    <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                        <TextField variant='filled' className='w-full' label='Nhập mật khẩu cũ' size='small' type='password' value={old_password}
                            error={touched && !old_password}
                            helperText={touched && !old_password ? 'Không được để trống' : ''}
                            onChange={(e) => setOld_password(e.target.value)}
                            onBlur={() => setTouched(true)} />
                        <TextField variant='filled' className='w-full' label='Nhập mật khẩu mới' size='small'
                            ...
                            onBlur={() => setTouched(true)} />
                        <TextField variant='filled' className='w-full' label='Xác nhận mật khẩu' size='small'
