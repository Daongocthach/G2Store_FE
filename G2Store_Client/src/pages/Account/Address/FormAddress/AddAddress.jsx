...
function AddAddress({ rerender, setRerender }) {
    ...
    return (
        <div>
            <Button size='small' sx={{ gap: 1, bgcolor: '#CD3333', color: 'white', borderRadius: 10, fontWeight: 'bold', ':hover': { bgcolor: '#B22222' } }}
                onClick={handleClickOpen}><AddCircle /> Thêm</Button>
            <Dialog open={open} onClose={handleClose} >
                ...
                <DialogContent >
                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1, width: '550px' }}>
                        <Typography minWidth={'100px'} variant='subtitle1' color={'#444444'}>Thông tin người nhận</Typography>
                        ...
                        <Typography minWidth={'100px'} variant='subtitle1' color={'#444444'}>Địa chỉ nhận hàng</Typography>
                ...
                <DialogActions>
                    ...
                    <Button onClick={handleClickAdd} size='small' sx={{ height: 35, fontWeight: 600, bgcolor: '#1E90FF', color: 'white' }} >Thêm</Button>
                </DialogActions>
            </Dialog>
            {loading && <Loading />}
        </div>
